...
1. Write the JSON schema describing your resource, `kms-key-enablekeyrotation.json`
2. Implement your resource handlers in `kms_key_enablekeyrotation/handlers.py`
