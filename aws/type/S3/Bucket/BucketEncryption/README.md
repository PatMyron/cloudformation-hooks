...
1. Write the JSON schema describing your resource, `s3-bucket-bucketencryption.json`
2. Implement your resource handlers in `s3_bucket_bucketencryption/handlers.py`
