# ApiGateway::DomainName::SecurityPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `apigateway-domainname-securitypolicy.json`
2. Implement your resource handlers in `apigateway_domainname_securitypolicy/handlers.py`
