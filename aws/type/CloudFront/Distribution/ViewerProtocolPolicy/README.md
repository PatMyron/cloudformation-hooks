# CloudFront::Distribution::ViewerProtocolPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `cloudfront-distribution-viewerprotocolpolicy.json`
2. Implement your resource handlers in `cloudfront_distribution_viewerprotocolpolicy/handlers.py`
