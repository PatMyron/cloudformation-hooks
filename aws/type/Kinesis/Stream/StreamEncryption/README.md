# Kinesis::Stream::StreamEncryption

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `kinesis-stream-streamencryption.json`
2. Implement your resource handlers in `kinesis_stream_streamencryption/handlers.py`
