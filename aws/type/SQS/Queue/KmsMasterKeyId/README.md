# SQS::Queue::KmsMasterKeyId

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `sqs-queue-kmsmasterkeyid.json`
2. Implement your resource handlers in `sqs_queue_kmsmasterkeyid/handlers.py`
