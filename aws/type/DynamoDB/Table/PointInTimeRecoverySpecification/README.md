...
1. Write the JSON schema describing your resource, `dynamodb-table-pointintimerecoveryspecification.json`
2. Implement your resource handlers in `dynamodb_table_pointintimerecoveryspecification/handlers.py`
